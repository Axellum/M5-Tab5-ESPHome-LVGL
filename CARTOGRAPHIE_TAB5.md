...
graph TD
    ...
    subgraph PKG["Packages ESPHome (Tab5/*.yaml) — 12 packages + pot_sensors.yaml (package paramétré, inclus ×5)"]
        ...
        API["tab5-api-logic.yaml<br/>345 lignes<br/>api: services: (contrat HA, 17 services, zéro lv_* — garde-fou)"]
