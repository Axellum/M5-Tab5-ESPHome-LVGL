...
graph TD
    ...
    subgraph PKG["Packages ESPHome (Tab5/*.yaml) — 12 packages"]
        ...
        HW["tab5-hardware.yaml<br/>528 lignes<br/>display/touch/i2c/audio/esp32_hosted/wake words (okay_nabu + Stop)/ota:"]
...
règles calendrier ouverture/fermeture, snooze, liste RDV, rendu LVGL<br/>lit cal_jours_data[] de tab5_custom.h — aucun id() ESPHome, aucun réseau"]
    ...
    subgraph CPP["C++ HMI (esphome: includes:)"]
        HFILE["tab5_custom.h (803L)<br/>CentralPanelCtx, Weather*Slot, UIColor::, MeteoIcon::"]
        CFILE["tab5_custom.cpp (3097L)<br/>logique LVGL HMI non-triviale"]
...
- **`tab5_custom.cpp` (3097 lignes au 08/09/2026)** — 7 responsabilités (UTF-8/texte, météo, carte centrale, assistant/markdown, calendrier, console, animations + horloge) ; découpage en unités de compilation recommandé par l'audit du 06/09 — `esphome: includes:` accepte plusieurs `.cpp`, comme pour les jeux.
