...
| `tab5-calendar.yaml` | 217 | Scripts du popup calendrier (lot 8c) : `tab5_calendar_open`, `tab5_cal_render`, `tab5_cal_prev/next/today`, `tab5_cal_prefetch_boot`, `tab5_cal_day_tap` ; seul envoi d'une demande de mois = `tab5_cal_request(annee, mois)`, « mois ± 1 » = `cal_shift_month()` (lot 7) | Calendrier | `tab5_calendar.cpp`, `calendar_popup.yaml` |
...
| `tab5_calendar.cpp` | 328 | `cal_store_month_data()`, `cal_render_month()`, `cal_render_day_detail()` (cache mensuel `static`) | voir `tab5_custom.h` |
