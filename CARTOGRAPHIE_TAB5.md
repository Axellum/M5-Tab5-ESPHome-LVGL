...
| `tab5_text.cpp` | 276 | UTF-8 / mojibake, store local des alertes rejetées, libellés français des jours/mois, `set_label_text_utf8()` | voir `tab5_custom.h` |
