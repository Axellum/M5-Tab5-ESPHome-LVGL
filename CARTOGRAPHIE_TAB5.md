...
| `tab5_assist.cpp` | 284 | `format_assist_markdown()`, `assist_set_pipeline_state()`, `assist_image_state_ui()`, `WakeWord::decide()` | voir `tab5_custom.h` |
...
| `assistant_popup.yaml` | 358 | Popup assistant vocal plein écran : colonne réglages (cerveau Domotique/Discussion, Ok Nabu, muet, volume, taille A-/A/A+) + transcription STT + réponse Markdown en monospace + image `online_image` à la demande (`tab5_assist_reponse`) | — |
