...
| `docs/*.md` (12 fichiers) | `architecture.md`, `hardware.md`, `ui_design.md`, `voice_assistant.md`, `installation.md`, `screens.md`, `demo_mode.md`, `troubleshooting.md`, `debugging.md`, `related_projects.md`, `arcade.md` (les 8 consoles), `INVENTAIRE_CONFIGS_TESTS.md` + `docs/decisions/` (ADR) + `docs/press/` (kit de publication Hackster) (12 ADR) + `docs/images/`. `docs/` ne contient que de la doc de référence : les anciens rapports d'audit LLM (synthétisés en #T161-#T169, cf. `audit_tab5/` côté workspace privé), les patchs de travail et les sauvegardes d'essais en ont été retirés |
