...
That's the "why." From here, I'll hand you over to the rest of this write-up — written by AI, and far more qualified than I am to talk about code, architecture, and hardware in detail. There are almost certainly a few rough edges left; the project keeps evolving regularly.
