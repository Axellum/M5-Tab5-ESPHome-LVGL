...
- `tab5_journal.cpp` — boot and outage journal (2026-09-26): `journal_log_message()` (`logger: on_message`) keeps errors, and warnings while HA is not connected, in `.noinit` RAM with an NVS copy after 2 min without HA; sent to HA as `esphome.tab5_journal` on reconnection (see `docs/debugging.md`)
